...
module.exports = function (app)	{
	...
	app.get('/getCustomerSubscriptionCount',adminGet.getCustomerSubscriptionCount);
	//User Post Requests
	...
	app.post('/getWaterLevelData',userPost.getWaterLevelData);
	app.post('/getWaveHeightData',userPost.getWaveHeightData);
	app.post('/getWindSpeedData',userPost.getWindSpeedData);
	app.post('/getWaterTemperatureData',userPost.getWaterTemperatureData);
	app.post('/getStreamHeightData',userPost.getStreamHeightData);
	app.post('/getStreamFlowData',userPost.getStreamFlowData);
